...
{
    public static class NewHrlFile
    {
        ...
        public static void Click(object sender, RadRoutedEventArgs e)
        {
            ...
            if (App.ViewModel.SelectVMItem is ProjectVM)
            {
                ...
                var newEntity = new FileEntity { Compilable = true, Parent = prj.Entity, Name = "newHrlFile.hrl" };
            ...
            else if (App.ViewModel.SelectVMItem is ItemVM)
            {
                ...
                var newEntity = new FileEntity { Compilable = false, Parent = itm.Entity, Name = "newHrlFile.hrl" };
