...
namespace ErlangEditor.Helper
{
    public class CompileHelper
    {
        ...
        public void MakeApp(PrjTreeItemVM aAppVM)
        {
            ...
            slnCompiler.Start(new ErlangEditor.Core.Entity.ApplicationEntity[] { aAppVM.Entity as ErlangEditor.Core.Entity.ApplicationEntity }, App.MainViewModel.ExportLog,null, (x) => { App.MainViewModel.AutoCompleteCache.ScanBin(aAppVM.Entity as ErlangEditor.Core.Entity.ApplicationEntity); });
        }
    }
}
